...
module.exports = class Unionpay {
    ...
    get urlPrefix ( ) {
        ...
        return this.#config.sandbox ?
            'https://newpayment-test.chinapay.com' : 
            // 'https://payment.chinapay.com' : 
            'https://payment.chinapay.com'
    }
    ...
    urls = {
        ...
        get frontTransReq ( ) { return this[secured] + '/CTITS/service/rest/forward/syn/000000000017/0/0/0/0/0' },
        get appTransReq ( ) { return this[secured] + '/CTITS/service/rest/forward/syn/000000000017/0/0/0/0/0'},
        get backTransReq ( ) { return this[secured] + '/CTITS/service/rest/forward/syn/000000000017/0/0/0/0/0'},
        get queryTrans ( ) { return this[secured] + '/CTITS/service/rest/forward/syn/000000000060/0/0/0/0/0'},
    }
    ...
    async createWebOrder ( form ) {
        ...
        if ( [ 'number', 'object' ].includes ( typeof txnTime ) ) {
            tranDate = Time.format ( txnTime, 'YYYYMMDD' )
            tranTime = Time.format ( txnTime, 'hhmmss' )
        }
        
        const sendBody = {
            Version: version,
            MerId : merId, 
            MerOrderNo: others.orderId,
            TranDate: tranDate,
            TranTime: tranTime,
            OrderAmt: others.txnAmt,
            BusiType: '0001',
            CurryNo: "CNY",
            MerBgUrl: consumeCallbackUrl,
            MerPageUrl: others.frontUrl,
            RemoteAddr: '47.243.79.251'
        }
